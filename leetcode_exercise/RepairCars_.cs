...
namespace leetcode_exercise
{
    ...
    /// 2594. 修车的最少时间
    /// </summary>
    internal class RepairCars_
    {
        public long RepairCars(int[] ranks, int cars)
        {

            long lower = 1;
            long upper =1L* ranks[0]*cars*cars;//一个人修cars 量车
            while (lower < upper)
            {
        ...
        bool Check(int[] ranks, int cars, long m)
        {
            int cnt = 0;
            foreach (int i in ranks)
            {
                cnt += (int)Math.Sqrt(m / i);
                if (cnt >= cars)
                    return true;
            }
        ...
        static void Main(string[] args)
        {
            ...
            //{
            //    int[] ranks = { 4, 2, 3, 1 };
            //    Console.WriteLine(r.RepairCars(ranks, 10));
            //}
            //{
            //    int[] ranks = { 5,1,8 };
            //    Console.WriteLine(r.RepairCars(ranks, 6));
            //}
            {
                ...
                Console.WriteLine(r.RepairCars(ranks, 292126));
            }
        }
    }
}
