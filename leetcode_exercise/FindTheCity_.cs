    ...
    internal class FindTheCity_
    {
        ...
        static void Main(string[] args)
        {
            FindTheCity_ f = new();
            {
                ...
                int ans = f.FindTheCity(n, edges, distanceThreshold);
